...
#samtools flagstat "$1"_bwamem_hg38.sort.bam > "$1"_flags_initial.txt;

#delete unnecessary files
#rm "$1"_bwamem_hg38.sam "$1"_bwamem_hg38.bam; 

# remove duplicates (picard)
if [ -f "$1"_bwamem_hg38.rmdup.bam ]
then
...
I="$1"_bwamem_hg38.rmdup.bam \
O="$1"_bwamem_hg38.pfm.bam \
SO=coordinate \
TMP_DIR="/data/projects_gibbons/scratch/test/" \
VALIDATION_STRINGENCY=LENIENT;

# index bam
samtools index "$1"_bwamem_hg38.pfm.bam;
